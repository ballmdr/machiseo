  ...
  head () {
    ...
    return {
      ...
      meta: [
        ...
        { hid: 'og_image', name: 'og:image', content: checkUrl(this.serie.field_poster[0].url) },
        ...
        { hid: 'twitter_image', name: 'twitter:image', content: checkUrl(this.serie.field_poster[0].url) },
