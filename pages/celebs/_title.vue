  ...
  head () {
    ...
    return {
      ...
      meta: [
        ...
        { hid: 'og_image', name: 'og:image', content: checkUrl(this.celeb.field_celeb_profile.url) },
        ...
        { hid: 'twitter_image', name: 'twitter:image', content: checkUrl(this.celeb.field_celeb_profile.url) },
