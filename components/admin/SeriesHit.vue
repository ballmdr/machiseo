  ...
  methods: {
    ...
    async serieHitSave () {
      for (let i=0;i<this.series.length;i++) {
        ...
        await this.$axios.get(process.env.restMongoUrl + '/admin/home/clear/series_hit')
        await this.$axios.post(process.env.restMongoUrl + '/admin/home/save/series_hit', this.series)
        const { data } = await this.$axios.get(process.env.restMongoUrl + '/admin/home/series_hit')
        this.series = data
      }
    }
  }
