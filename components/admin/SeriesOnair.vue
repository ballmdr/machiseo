  ...
  methods: {
    ...
    async serieHitSave () {
      for (let i=0;i<this.series.length;i++) {
        ...
        await this.$axios.get(process.env.restMongoUrl + '/admin/home/clear/series_onair')
        await this.$axios.post(process.env.restMongoUrl + '/admin/home/save/series_onair', this.series)
        const { data } = await this.$axios.get(process.env.restMongoUrl + '/admin/home/series_onair')
        this.series = data
      }
    }
  }
